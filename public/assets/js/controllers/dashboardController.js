app.controller("dashboardController", function ($scope, $location, $rootScope, $http) {
	...
	function getUserById(user) {
		return user._id == $rootScope.user_id;
	}
	...
	$scope.currentUser = Array.prototype.find.call($rootScope.users, getUserById);
	...
	var map = new google.maps.Map(document.getElementById('map'), {
		zoom: 8,
		center: { lat: $scope.currentUser.coords.lat, lng: $scope.currentUser.coords.lng },
